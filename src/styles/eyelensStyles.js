export function injectStyles() {
  ...
  style.textContent = `
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    body { font-family: var(--font-b); -webkit-font-smoothing:antialiased; zoom: var(--ui-scale); background: var(--background); color: var(--text-primary); overflow-x:hidden; }
    ...
    .hero-left {
      ...
      padding:64px 40px 64px 56px; position:relative; z-index:2;
    }
    .hero-badge {
    ...
    /* ── PLP ── */
    .plp-header { background:var(--g50); border-bottom:1px solid var(--g100); padding:72px 40px 28px; }
    .plp-header h1 { font-family:var(--font-d); font-size:clamp(32px,4vw,52px); font-weight:800; color:var(--black); letter-spacing:-.02em; }
    .plp-layout { display:grid; grid-template-columns:240px 1fr; gap:24px; padding:20px 0 44px; }
    ...
    .pdp-layout > div:first-child { position:sticky; top:84px; align-self:start; }
    .gallery-main {
    ...
    .gallery-thumbs { display:flex; gap:8px; margin-top:8px; overflow-x:auto; -webkit-overflow-scrolling:touch; padding-bottom:2px; }
    .g-thumb {
    ...
    .pdp-desc-reviews-quick { display:block; }
    ...
    .pdp-price-wrap { margin-bottom:14px; display:flex; flex-wrap:wrap; align-items:baseline; gap:8px 14px; }
    ...
    .color-swatches { display:flex; gap:10px; margin-bottom:12px; }
    .c-swatch {
    ...
    .pdp-cta { display:grid; gap:10px; margin-bottom:20px; }
    .pdp-cta-main { width:100%; }
    .pdp-cta-sub { display:flex; gap:10px; align-items:center; }
    .pdp-order-primary {
      font-weight:800;
      min-height:50px;
      letter-spacing:.01em;
      box-shadow:0 6px 18px rgba(102,120,113,.28);
    }
    .pdp-order-secondary {
      font-weight:700;
      min-height:50px;
    ...
    .pdp-order-wish { min-height:44px; min-width:44px; padding:0 12px; }
    .pdp-order-primary:disabled,
    .pdp-order-secondary:disabled {
      opacity:.75;
      cursor:not-allowed;
    }
    ...
    .order-summary { position:sticky; top:80px; background:var(--white); border:1px solid var(--g100); border-radius:20px; padding:20px; }
    ...
    /* ── Checkout ── */
    .checkout-grid { display:grid; grid-template-columns:1fr 380px; gap:20px; padding:44px 0; }
    .checkout-section { background:var(--white); border:1px solid var(--g100); border-radius:20px; padding:20px; margin-bottom:14px; }
    ...
    /* ── Account ── */
    .account-layout { display:grid; grid-template-columns:260px 1fr; gap:20px; padding:44px 0; }
    ...
    /* ── Tabs ── */
    .tab-bar { display:flex; border-bottom:2px solid var(--g100); margin-bottom:28px; gap:4px; overflow-x:auto; -webkit-overflow-scrolling:touch; }
    .tab-btn {
      ...
      position:relative; transition:color var(--tr); white-space:nowrap; flex-shrink:0;
    }
    ...
    .pdp-sticky-price { font-family:var(--font-n); font-size:20px; font-weight:800; color:var(--black); flex-shrink:0; }
      .pdp-sticky-cta .pdp-order-primary { min-height:44px; padding:10px 14px; box-shadow:none; }
      .pdp-sticky-cta .pdp-order-secondary { min-height:44px; padding:10px 14px; }
    ...
    @media (max-width:768px) {
      ...
      .about-values-grid { grid-template-columns:1fr 1fr !important; gap:10px !important; }
      .stats-grid { grid-template-columns:1fr 1fr !important; }
      .signup-page { padding-top:56px !important; }
      ...
      .pdp-desc-reviews-quick { display:none; }
      ...
      .cart-page { padding-top:56px !important; }
      ...
      .cart-page .table-scroll { display:block !important; width:100%; }

      /* Checkout */
      .checkout-grid { grid-template-columns:1fr; gap:14px; padding:20px 0 80px; }
      .checkout-page { padding-top:56px !important; }
      ...
      .checkout-saved-list .btn { align-items:flex-start; }

      /* Account */
      .account-layout { grid-template-columns:1fr; gap:14px; padding:20px 0 80px; }
      .account-page { padding-top:56px !important; }
      ...
      .account-return-actions { flex-direction:column; }
      .account-return-actions .btn { width:100%; }
      ...
      .adm-card form div[style*="grid-template-columns"],
      .adm-modal-body form div[style*="grid-template-columns"] { grid-template-columns:1fr !important; }
      .adm-modal { width:min(96vw, 680px); max-width:96vw; }
      .adm-modal-body { overflow-x:hidden; }
      .adm-table { min-width:720px; } /* keep content readable; wrapper scrolls */
    ...
    @media (max-width:480px) {
      ...
      .kpi-grid { gap:6px; }
      .checkout-saved-list .btn { padding:9px 10px !important; }
      .checkout-saved-list .btn > span:first-child { min-width:0; word-break:break-word; }
      .checkout-saved-list .btn > span:last-child { font-size:11px !important; }
      .account-page .badge { font-size:10px !important; padding:3px 8px !important; }
      .account-order-actions { width:100%; }
      .account-order-actions .btn { font-size:12px; padding:8px 10px; }
      .cart-item { align-items:flex-start; }
      .cart-item > div:last-child { width:100%; text-align:left !important; margin-top:6px; }
      .cart-item > div:last-child > div { font-size:16px !important; }
    }

    @media (max-width:420px) {
      .navbar { height:54px; padding:0 10px; }
      .nav-logo-img { max-width:min(132px, 44vw); }
      .nav-right { gap:6px; }
      .nav-icon-btn { width:32px; height:32px; border-radius:9px; }
      .cart-badge { width:16px; height:16px; font-size:9px; top:-5px; right:-5px; }
      .mobile-bottom-nav-inner { gap:2px; }
      .mob-nav-btn { flex:1; min-width:0; padding:6px 4px; }
      .mob-nav-label { font-size:9px; }
      .pdp-cta-sub { flex-wrap:wrap; }
      .pdp-cta-sub .pdp-order-secondary,
      .pdp-cta-sub .pdp-order-wish { width:100%; }
      .pdp-sticky-inner { align-items:flex-start; }
      .pdp-sticky-inner > div:last-child { width:100%; }
      .pdp-sticky-inner .pdp-order-secondary { width:100%; }
    }
    ...
    @media (max-width:360px) {
      ...
      .account-page .acct-nav-item { min-width:60px; padding:9px 10px; }
      .account-page .acct-nav-item span:last-child { font-size:11px !important; }
      .account-return-actions .btn { font-size:12px; padding:9px 10px; }
      .account-page [style*="maxWidth: 440"] { max-width:100% !important; }
    }
  `;
